#' Getting Read codes from ICD codes
#'
#' This function retrieves read codes from ICD codes.
#' @param code ICD code to look up. Can be single term, or vector. Returned vector from stringToICD function can be used.
...
ICDToRead <- function(code, ICD, read) {
  ...
  codes <- ref[icd %in% code, readCode] %>%
    unique
